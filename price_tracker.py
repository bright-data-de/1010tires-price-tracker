...
Info  : https://brightdata.de/products/insights/price-tracker/1010tires
"""
...
# https://brightdata.de/products/web-scraper/1010tires
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your 1010tires scraper at: https://brightdata.de/products/web-scraper/1010tires\n"
